...
(1, 1, 25), (1, 5, 12), (2, 4, 6), (3, 3, 12), (4, 2, 20),
(5, 5, 30), (6, 2, 40), (6, 5, 27), (7, 1, 10), (8, 2, 18);
...
(1, 1, '1994-12-15', 5), (1, 3, '1994-12-18', 6), (1, 6, '1994-09-14', 7),
(2, 1, '1994-05-08', 20), (2, 4, '1994-05-10', 10), (2, 5, '1994-12-16', 5),
(3, 4, '1994-10-06', 10), (3, 7, '1994-10-06', 18),
(4, 1, '1994-09-07', 20), (4, 6, '1994-05-12', 7);
...
-- Công nhân có năm sinh 1945, 1940, 1948 (Cách 1)
SELECT * FROM worker WHERE birthday = 1945 OR birthday = 1940 OR birthday = 1948;

-- Công nhân có năm sinh 1945, 1940, 1948 (Cách 2)
SELECT * FROM worker WHERE birthday IN (1945, 1940, 1948);

-- Công trình có chi phí đầu tư từ 200 đến 500 triệu đồng (Cách 1)
SELECT * FROM building WHERE cost >= 200 AND cost <= 500;

-- Công trình có chi phí đầu tư từ 200 đến 500 triệu đồng (Cách 2)
